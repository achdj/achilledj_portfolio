...
const props = defineProps({
  action: {
    ...
    label: String,
    default: () => ({
      route: "mailto:achilledjegnon@gmail.com",
      color: "bg-gradient-warning",
      label: "Me contactez immédiatement"
    })
  },
  transparent: {
    type: Boolean,
  ...
  >
    ...
    >
      <RouterLink
        ...
        rel="tooltip"
        title="Designed and Coded by Achille DJEGNON"
      ...
      <a
        href="mailto:achilledjegnon@gmail.com"
      ...
      >
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          <a
            href='#acceuil'
            class="text-dark font-weight-bolder d-flex align-items-center px-1 mx-2"
          >
            <span>Accueil</span>
          </a>
          <a
